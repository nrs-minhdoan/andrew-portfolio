...
const ContentSecurityPolicy = [
  ...
  `script-src 'self' https://static.cloudflareinsights.com ${isDev ? "'unsafe-eval' 'unsafe-inline'" : "'unsafe-inline'"}`,
  `connect-src 'self' https://cloudflareinsights.com ${isDev ? "ws: wss:" : ""}`.trim(),
  `manifest-src 'self'`,
